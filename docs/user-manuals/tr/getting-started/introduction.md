...
- **Dürüst doğrulama kabiliyeti** — 41 dedektör türü doğrudan canlı kontrole sahiptir, 7'si güvenilir issuer/bölge/eşlik eden bağlam gerektirir, 6'sı çevrimdışı format doğrular. Registry sayısı hiçbir zaman canlı kapsam gibi sunulmaz.
