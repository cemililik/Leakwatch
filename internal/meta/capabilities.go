...
var verificationCapabilities = []VerificationCapability{
	...
	{DetectorID: "aws-access-key-id", VerifierKind: VerifierLive, RequiredContextFields: []string{"aws_secret_access_key"}, EndpointClass: "fixed_provider_sdk", InactiveStatusContract: "typed_authentication_error"},
	...
	{DetectorID: "coinbase-api-key", VerifierKind: VerifierFormatOnly, RequiredContextFields: []string{"api_secret"}, EndpointClass: "offline_format", InactiveStatusContract: "none"},
	{DetectorID: "database-connection-string", VerifierKind: VerifierNone, EndpointClass: "none", InactiveStatusContract: "none"},
	{DetectorID: "databricks-token", VerifierKind: VerifierLive, RequiredContextFields: []string{"workspace_host"}, EndpointClass: "detector_context_provider_api", InactiveStatusContract: "definitive_provider_auth_rejection"},
	{DetectorID: "datadog-api-key", VerifierKind: VerifierLive, EndpointClass: "fixed_provider_api", InactiveStatusContract: "definitive_provider_auth_rejection"},
	...
	{DetectorID: "github-oauth-token", VerifierKind: VerifierLive, EndpointClass: "fixed_provider_api", InactiveStatusContract: "definitive_provider_auth_rejection"},
	{DetectorID: "github-token", VerifierKind: VerifierLive, EndpointClass: "fixed_provider_api", InactiveStatusContract: "definitive_provider_auth_rejection"},
	...
	{DetectorID: "hashicorp-vault-token", VerifierKind: VerifierNone, RequiredContextFields: []string{"vault_address"}, EndpointClass: "none", InactiveStatusContract: "none"},
	...
	{DetectorID: "okta-api-token", VerifierKind: VerifierLive, RequiredContextFields: []string{"org_domain"}, EndpointClass: "detector_context_provider_api", InactiveStatusContract: "definitive_provider_auth_rejection"},
	...
	{DetectorID: "shopify-access-token", VerifierKind: VerifierRequiresContext, RequiredContextFields: []string{"store_domain"}, EndpointClass: "missing_companion_context", InactiveStatusContract: "trusted_store_auth_rejection"},
	...
	{DetectorID: "snyk-api-key", VerifierKind: VerifierLive, EndpointClass: "fixed_provider_api", InactiveStatusContract: "definitive_provider_auth_rejection"},
	...
	{DetectorID: "supabase-service-key", VerifierKind: VerifierLive, EndpointClass: "credential_derived_provider_api", InactiveStatusContract: "definitive_provider_auth_rejection"},
	...
	{DetectorID: "twilio-api-key", VerifierKind: VerifierRequiresContext, RequiredContextFields: []string{"account_sid", "api_key_secret"}, EndpointClass: "missing_companion_context", InactiveStatusContract: "paired_credential_auth_rejection"},
