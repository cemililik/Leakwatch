...
// LastContractReviewedAt and ContractReferenceURLs are intentionally empty
// until the provider contract has been checked against current primary
// documentation; an empty value must never be presented as a completed audit.
...
var verificationCapabilities = []VerificationCapability{
	...
	{DetectorID: "auth0-management-token", VerifierKind: VerifierRequiresContext, RequiredContextFields: []string{"trusted_api_origin"}, ProviderRegions: []string{"Auth0 tenant", "Custom domain"}, EndpointClass: "operator_context_provider_api", InactiveStatusContract: "trusted_origin_http_401", LastContractReviewedAt: "2026-08-11", ContractReferenceURLs: []string{"https://auth0.com/docs/secure/tokens/access-tokens/validate-access-tokens"}},
	...
	{DetectorID: "newrelic-api-key", VerifierKind: VerifierLive, ProviderRegions: []string{"US", "EU"}, EndpointClass: "bounded_regional_provider_api", InactiveStatusContract: "all_regions_http_401", LastContractReviewedAt: "2026-08-10", ContractReferenceURLs: []string{"https://docs.newrelic.com/docs/apis/nerdgraph/get-started/introduction-new-relic-nerdgraph/"}},
	...
	{DetectorID: "shopify-access-token", VerifierKind: VerifierRequiresContext, RequiredContextFields: []string{"trusted_store_origin"}, EndpointClass: "operator_context_provider_api", InactiveStatusContract: "trusted_store_http_401", LastContractReviewedAt: "2026-08-11", ContractReferenceURLs: []string{"https://shopify.dev/docs/api/admin-graphql/latest/queries/shop"}},
	{DetectorID: "slack-token", VerifierKind: VerifierLive, EndpointClass: "fixed_provider_api", InactiveStatusContract: "provider_body_auth_rejection", LastContractReviewedAt: "2026-08-11", ContractReferenceURLs: []string{"https://api.slack.com/methods/auth.test"}},
	...
	{DetectorID: "snyk-api-key", VerifierKind: VerifierRequiresContext, RequiredContextFields: []string{"trusted_api_origin"}, ProviderRegions: []string{"US1", "US2", "EU", "AU", "GOV", "PRIVATE"}, EndpointClass: "operator_context_provider_api", InactiveStatusContract: "trusted_origin_http_401", LastContractReviewedAt: "2026-08-11", ContractReferenceURLs: []string{"https://docs.snyk.io/snyk-api/reference/users", "https://docs.snyk.io/snyk-api/authentication-for-api"}},
	...
	{DetectorID: "supabase-service-key", VerifierKind: VerifierLive, EndpointClass: "fixed_provider_api", InactiveStatusContract: "http_401_only", LastContractReviewedAt: "2026-08-11", ContractReferenceURLs: []string{"https://supabase.com/docs/reference/api/introduction"}},
	...
	{DetectorID: "twilio-api-key", VerifierKind: VerifierRequiresContext, RequiredContextFields: []string{"api_key_sid", "trusted_api_origin"}, ProviderRegions: []string{"US1", "IE1", "AU1"}, EndpointClass: "operator_context_provider_api", InactiveStatusContract: "trusted_origin_http_401", LastContractReviewedAt: "2026-08-11", ContractReferenceURLs: []string{"https://www.twilio.com/docs/iam/api/keys"}},
...
func VerificationCapabilities() []VerificationCapability {
	...
	for i, capability := range verificationCapabilities {
		...
		out[i].ContractReferenceURLs = append([]string(nil), capability.ContractReferenceURLs...)
	}
	return out
}
